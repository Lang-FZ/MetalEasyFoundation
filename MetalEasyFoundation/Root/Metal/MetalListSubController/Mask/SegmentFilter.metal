...
fragment half4 segmentFragment(SingleInputVertexIO fragmentInput [[stage_in]], texture2d<half> inputTexture [[texture(0)]], texture2d<half> mask [[texture(1)]], texture2d<half> material [[texture(2)]], constant SegmentUniform &uniforms [[buffer(1)]]) {
    ...
    return half4(mix(baseColor, materialColor, (1 - maskColor.r) * uniforms.alpha));
}
